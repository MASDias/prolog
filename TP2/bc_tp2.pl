...
gerar_populacao(Pop):-
	...
	gera_populacao(TamanhoPopulacao,ListaCidades,NumCidades,Pop_sem_custo),
	gerar_populacao_custo(Pop_sem_custo,Pop).

gerar_populacao_custo([],_):-!.
gerar_populacao_custo([H|T],Pop):-
	custo(H,Custo),
	gerar_populacao_custo(T,Pop),
